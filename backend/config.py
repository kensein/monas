...
MODEL_VAR_MAP = {
    "InaNWP": {
        ...
        "pressure_qff_mb_derived": ["mslp", "MSLP", "PSFC", "pres", "sp"],
        "pressure_qfe_mb_derived": ["pres", "PSFC", "mslp", "sp"],
        "pressure_reading_mb": ["pres", "PSFC", "mslp", "sp"],
        "wind_speed_ff": ["ws10", "WS10", "wind_speed"],
        "wind_dir_deg_dd": ["wd10", "WD10"],
        "rainfall_6h_rrr": ["rain", "rainnc", "RAINNC", "rainc", "RAINC", "tp", "precip"],
